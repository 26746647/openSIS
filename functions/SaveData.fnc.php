...
//                                    {
//                                        $select_parent=DBGet(DBQuery('SELECT STAFF_ID FROM students_join_people WHERE STUDENT_ID=\''.$_REQUEST[student_id].'\''));
//                                     
//                                        foreach($select_parent as $key)
//                                        {
//                                            $parent=DBGet(DBQuery('SELECT * FROM staff s,staff_school_relationship ssr WHERE s.STAFF_ID=ssr.STAFF_ID AND s.STAFF_ID=\''.$key[STAFF_ID].'\' AND ssr.SYEAR=\''.UserSyear().'\' AND CURRENT_SCHOOL_ID=\''.UserSchool().'\''));
//                                           
//                                            if($parent)
//                                            {
//                                                
