...
//        $chk_attendance = mysql_fetch_array(mysql_query("SELECT PERIOD_ID FROM course_periods WHERE COURSE_PERIOD_ID='". $cp_id."'"));
        $chk_attendance = mysql_fetch_array(mysql_query("SELECT PERIOD_ID FROM course_period_var cpv WHERE COURSE_PERIOD_ID='". $cp_id."'"));
   ...
   if($period_id!='')
    ...
    $chk_atten_cp=mysql_fetch_array(mysql_query("SELECT DOES_ATTENDANCE FROM course_period_var WHERE COURSE_PERIOD_ID='". $cp_id."'"));
