...
if($_REQUEST['course_modfunc']=='search')
{
	...
	echo '<TABLE><TR><TD><INPUT type=text class=cell_floating name=search_term value="'.$_REQUEST['search_term'].'"></TD><TD><INPUT type=submit class=btn_medium value=Search onclick=\'formload_ajax("F1")\';><INPUT type=submit class=btn_medium value=Cancel onclick="close_window();"></TD></TR></TABLE>';
	echo '</FORM>';
	PopTable('footer');
