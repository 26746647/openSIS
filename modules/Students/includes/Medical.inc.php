...
if(!$_REQUEST['modfunc'])
{
	...
	echo '<div class=hseparator><b>Medical Information</b></div><div class=clear></div>';
        ...
        echo '<TABLE cellpadding=5>';
			...
			echo TextInput($student['PHYSICIAN'],'medical_info[PHYSICIAN]','','class=cell_medium');
			echo '</TD>';
			echo '</TR>';

                        echo '<TR>';
			echo "<td>Physician's Phone</td><td>:</td><td>";
			echo TextInput($student['PHYSICIAN_PHONE'],'medical_info[PHYSICIAN_PHONE]','','class=cell_medium');
			echo '</TD>';
			echo '</TR>';

                        echo '<TR>';
			echo '<td>Preferred Medical Facility</td><td>:</td><td>';
			echo TextInput($student['PREFERRED_HOSPITAL'],'medical_info[PREFERRED_HOSPITAL]','','class=cell_medium');
			echo '</TD>';
			echo '</TR>';
