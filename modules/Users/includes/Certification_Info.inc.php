...
{
//echo 'start <pre>';print_r($_REQUEST);echo '</pre> end';
...
$cert_RET = DBGet($QI,array(  'STAFF_CERTIFICATION_NAME'=>'_makeTextInput'
	...
	$link['add']['html'] = array('STAFF_CERTIFICATION_NAME'=>_makeTextInput('','STAFF_CERTIFICATION_NAME'),'STAFF_CERTIFICATION_CODE'=>_makeTextInput('','STAFF_CERTIFICATION_CODE'), 'STAFF_CERTIFICATION_DATE'=>_makeDateInput('','STAFF_CERTIFICATION_DATE'),
            'STAFF_CERTIFICATION_SHORT_NAME'=>_makeTextInput('','STAFF_CERTIFICATION_SHORT_NAME'),'STAFF_PRIMARY_CERTIFICATION_INDICATOR'=>_makeSelectInput('','STAFF_PRIMARY_CERTIFICATION_INDICATOR'),
              ...
              'STAFF_CERTIFICATION_EXPIRY_DATE'=>_makeDateInput('','STAFF_CERTIFICATION_EXPIRY_DATE'),
