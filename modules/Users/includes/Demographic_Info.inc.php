...
echo '<table id="span_disability_desc"><tr><td>Disability Description</td><td>:</td><td>'.TextAreaInput($staff['DISABILITY_DESC'],'staff[DISABILITY_DESC]','', '', 'true').'</td></tr></table>';
}else{
    echo '<table id="span_disability_desc" style="display:none"><tr><td>Disability Description</td><td>:</td><td>'.TextAreaInput('','staff[DISABILITY_DESC]','', '', 'true').'</td></tr></table>';
}
