...
#
#***************************************************************************************
//include 'modules/Users/config.inc.php';
   ...
   if($_REQUEST['address_id']!='' && $_REQUEST['address_id']!='new'){
	...
	if(isset($_REQUEST['address_id']))
	{
		...
		if($_REQUEST['address_id']!='0' && $_REQUEST['address_id']!=='old')
		{
			...
			echo '<TR><td><span class=red></span>Street Address 1</td><td>:</td><TD style=\"white-space:nowrap\"><table cellspacing=0 cellpadding=0 cellspacing=0 cellpadding=0 border=0><tr><td>'.TextInput($this_address['STAFF_ADDRESS1_PRIMARY'],'values[ADDRESS][STAFF_ADDRESS1_PRIMARY]','','class=cell_medium').'</td><td>';
			...
			echo '<TABLE>';
			echo '<TR><td style=width:120px>Street Address 1</td><td>:</td><TD>'.TextInput($this_address['STAFF_ADDRESS1_MAIL'],'values[ADDRESS][STAFF_ADDRESS1_MAIL]','','class=cell_medium').'</TD>';
			...
			echo '<TR><td><span class=red></span>Home Phone</td><td>:</td><TD>'.TextInput($this_contact['STAFF_HOME_PHONE'],'values[CONTACT][STAFF_HOME_PHONE]','','class=cell_medium').'</TD></tr>';
...
############################################################################################		
			...
			echo '<TR><td><span class=red></span>First Name</td><td>:</td><TD>'.TextInput($this_emer_contact['STAFF_EMERGENCY_FIRST_NAME'],'values[EMERGENCY_CONTACT][STAFF_EMERGENCY_FIRST_NAME]','','class=cell_medium').'</TD></tr>';
			...
			echo '<tr><td style=width:120px><span class=red></span>Relationship to Staff</TD><td>:</td><td>'._makeAutoSelectInputX($this_emer_contact['STAFF_EMERGENCY_RELATIONSHIP'],'STAFF_EMERGENCY_RELATIONSHIP','EMERGENCY_CONTACT','',$relation_options).'</TD></tr>';
