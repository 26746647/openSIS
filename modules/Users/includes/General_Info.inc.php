...
echo TextInput($staff['EMAIL'],'people[EMAIL]','','size=25 maxlength=100 id=email class=cell_floating');
...
//	{
//		$profiles_RET = DBGet(DBQuery('SELECT ID,TITLE FROM user_profiles WHERE PROFILE=\''.$staff['PROFILE'].'\' AND ID <>0 GROUP BY PROFILE ORDER BY ID'));
