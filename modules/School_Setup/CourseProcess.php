...
//echo $course_period_var_id;
$_REQUEST['modname']='School_Setup/Courses.php';
switch ($task)
{
    case 'md':
...
//            $header .='<TR class="'.$rowcolor.'"><TD>' .CheckboxInput($value, 'course_period_variable[' . $course_period_id . '][' . $day . '][DAYS]','', '', false, '', '', false,'id='.$day.' onchange=cp_toggle(this);') .'<label for='.$day.'>'.$day_val.'</label></TD>';
