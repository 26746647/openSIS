    ...
    <td valign='middle' height='100%'><table class='wrapper' border='0' cellspacing='0' cellpadding='0' align='center'>
        ...
        <tr>
          <td class='content'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
              <tr>
				...
				<table border='0' width='100%' cellspacing='2' cellpadding='2' align=center>
                  ...
                  <tr>
                   ...
                   echo "<td width='60%'><input name='USERNAME' type='text' class='login_txt' value=$name></td>
                  </tr>
                  <tr>
                    <td align='right'>Password :</td>";
                    if(isset($_COOKIE['remember_me_pwd']))  $pwd=$_COOKIE['remember_me_pwd']; 
                    echo "<td><input name='PASSWORD' class='login_txt' type='password' AUTOCOMPLETE = 'off' value=$pwd ></td>
                  </tr>";?>
                 <tr><td></td><td><input type="checkbox" name="remember" id="remember" <?php if(isset($_COOKIE['remember_me_name'])) { echo 'checked="checked"'; } else { echo ''; } ?> />Remember Me</td> </tr>
                <?php
	        ...
	        echo "</td></tr><tr>
                    <td></td>
                    <td><input name='log' type='submit' class='login' value='' onMouseDown=Set_Cookie('dhtmlgoodies_tab_menu_tabIndex','',-1) />";
//                    echo "<a href=forget.php>Forgot User Name/Password</a>";
                           echo "</td>
                  </tr>
				  </table>
				  </td>
